...
```{r, echo=FALSE}
Cucuta$cost_day <- round(Cucuta$cost_day,1)
names(Cucuta) = c("Año-mes", "Grupo-Demo", "Sexo", "Costo diario", "Dieta", "Mes", "Año")


Cucuta$`Costo diario` <- as.character(Cucuta$`Costo diario`)
Cucuta$Año <- as.character(Cucuta$Año)
Cucuta$Mes <- as.character(Cucuta$Mes)
Cucuta$Sexo <- as.character(Cucuta$Sexo)




datatable(Cucuta[, 2:7], 
          filter = 'top', 
          options = list(
...
file_path <- "txt-imputacion/output_Cucuta.txt"
