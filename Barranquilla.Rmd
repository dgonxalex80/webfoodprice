...
```{r, echo=FALSE}
Barranquilla$cost_day <- round(Barranquilla$cost_day,1)
names(Barranquilla) = c("Año-mes", "Grupo-Demo", "Sexo", "Costo diario", "Dieta", "Mes", "Año")


Barranquilla$`Costo diario` <- as.character(Barranquilla$`Costo diario`)
Barranquilla$Año <- as.character(Barranquilla$Año)
Barranquilla$Mes <- as.character(Barranquilla$Mes)
Barranquilla$Sexo <- as.character(Barranquilla$Sexo)

datatable(Barranquilla[, 2:7], 
          filter = 'top', 
          options = list(
...
exclude_words <- c("Barranquilla",
  ...
  "Average daily cost per", "Thiamine", "to input them", "use the optional parameter called", "VitaminA", "VitaminC", "Zinc","Calcium", "tacos", "Cali","Folate","Lipids", "Phosphorus","Riboflavin","Calabacín"
)
