...
```{r, echo=FALSE}
Pasto$cost_day <- round(Pasto$cost_day,1)
names(Pasto) = c("Año-mes", "Grupo-Demo", "Sexo", "Costo diario", "Dieta", "Mes", "Año")


Pasto$`Costo diario` <- as.character(Pasto$`Costo diario`)
Pasto$Año <- as.character(Pasto$Año)
Pasto$Mes <- as.character(Pasto$Mes)
Pasto$Sexo <- as.character(Pasto$Sexo)
...
file_path <- "txt-imputacion/output_Pasto.txt"
...
exclude_words <- c("Pasto", "Average daily cost per",
...
"cogote", "murillo", "paletero", "bota", "Riboflavin", "Huila")
