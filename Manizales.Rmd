...
Manizales$`Costo diario` <- as.character(Manizales$`Costo diario`)
Manizales$Año <- as.character(Manizales$Año)
Manizales$Mes <- as.character(Manizales$Mes)
Manizales$Sexo <- as.character(Manizales$Sexo)
...
file_path <- "txt-imputacion/output_Manizales.txt"
